...
namespace C64GBOnline.WPF
{
    public static class View
    {
        ...
        public static readonly DependencyProperty ModelProperty = DependencyProperty.RegisterAttached("Model", typeof(object), typeof(View), new(DefaultModelValue, (dependencyObject, eventArgs) =>
        {
        ...
        private static void SetContentProperty(DependencyObject targetLocation, FrameworkElement? view)
        {
            ...
            if (property is null) throw new InvalidOperationException($"Unable to find a Content property on type {type.Name}. Make sure you're using 'View.Model' on a suitable container, e.g. a ContentControl");
